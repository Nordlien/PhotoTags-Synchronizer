...
namespace PhotoTagsSynchronizer
{
    ...
    public partial class MainForm : Form
    {
        ...
        private Size maxCoverartSize = new Size(2048, 2048);
        ...
        private ThumbnailDatabaseCache databaseThumbnail;
        ...
        public MainForm()
        {
            ...
            databaseThumbnail = new ThumbnailDatabaseCache(databaseUtilitiesSqliteMetadata);
        ...
        private void tabControlToolbox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //UpdateSelecteFilesOnActiveDataGrivView(imageListView1.SelectedItems);
        }
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            if (Directory.Exists(folder)) folderTreeViewFolder.DrillToFolder(folder);
            
            FolderSelected_AggregateListViewWithFilesFromFolder(this.folderTreeViewFolder.GetSelectedNodePath());
        ...
        private void ToolStripMenuItemPeopleSelected_Click(object sender, EventArgs e)
        {
        ...
        private void toolStripButtonHistortyColumns_CheckedChanged(object sender, EventArgs e)
        {
            ...
            //PopulateSelectedGrivViewInvokeSetFlagNotAggregated(imageListView1.SelectedItems); //Can be optimized, instead of reload all, just hide and show columns
        }
        ...
        #region folderTreeViewFolder Drag and Drop
        ...
        private void folderTreeViewFolder_DragDrop(object sender, DragEventArgs e)
        {
            ...
            TreeNode targetNode = folderTreeViewFolder.GetNodeAt(targetPoint);

            // Retrieve the node that was dragged.  
            TreeNode draggedNode = (TreeNode)e.Data.GetData(typeof(TreeNode));

            string fileDirectoryTarget = Furty.Windows.Forms.ShellOperations.GetFileDirectory(targetNode);

            #region Move media files to new folder
            ...
            if (files != null)
            {
                ...
                foreach (string oldFullFilename in files) 
                {
                    string oldFilename = Path.GetFileName(oldFullFilename);
                    string newFullFilename = Path.Combine(fileDirectoryTarget, oldFilename);
            ...
            string fileDirectorySource = Furty.Windows.Forms.ShellOperations.GetFileDirectory(draggedNode);
            ...
            if (!draggedNode.Equals(targetNode) && !ContainsNode(draggedNode, targetNode))
            {
                ...
                if (e.Effect == DragDropEffects.Move)
                {
                    ...
                    try
                    {
                        string newTagretDirectory = Path.Combine(fileDirectoryTarget, new DirectoryInfo(fileDirectorySource).Name);
                        if (fileDirectorySource == newTagretDirectory) return; //Can't move into itself. No need for error message
                        System.IO.Directory.Move(fileDirectorySource, newTagretDirectory);
                        ...
                        ntn.Tag = "DUMMYNODE";
                        targetNode.Nodes.Add(ntn);

                        //folderTreeViewFolder.CollapseAll();
                    ...
                    {
                        MessageBox.Show("Was not able to move directory from " + fileDirectorySource + " to: " + fileDirectoryTarget);
                    }
                }

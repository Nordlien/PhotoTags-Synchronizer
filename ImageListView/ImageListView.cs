...
namespace Manina.Windows.Forms
{
    ...
    public partial class ImageListView : Control
    {
        ...
        public Image StatusIconFileOffline { get; set; } = null;
        ...
        /// <param name="requestedSize">The size of requested thumbnail, not size of coverted size.</param>
        /// <param name="error">Determines whether an error occurred during thumbnail extraction.</param>
        /// <param name="wasThumbnailReadFromFile">Determines whether thumbnail was extraction from file or from other sources.</param>
        internal void OnThumbnailCachedInternal(Guid guid, Image thumbnail, Size requestedSize, bool error, bool wasThumbnailReadFromFile, bool didErrorOccureReadFromFile)
        {
        ...
        {                      //RetrieveVirtualItemThumbnailInternal
        ...
        /// </summary>
        /// <param name="e">A RetrieveImageEventArgs that contains event data.</param>
        protected virtual void OnRetrieveItemMetadataDetails(RetrieveItemMetadataDetailsEventArgs e)
        {
        ...
        /// </summary>
        /// <param name="e">A RetrieveImageEventArgs that contains event data.</param>
        internal virtual void RetrieveItemMetadataDetailsInternal(RetrieveItemMetadataDetailsEventArgs e)
        {
        ...
        /// </summary>
        /// <param name="e">A RetrieveImageEventArgs that contains event data.</param>
        protected virtual void OnRetrieveItemImage(RetrieveItemImageEventArgs e)
        {
        ...
        /// </summary>
        /// <param name="e">A RetrieveImageEventArgs that contains event data.</param>
        internal virtual void RetrieveItemImageInternal(RetrieveItemImageEventArgs e)
        {
        ...
        /// </summary>
        /// <param name="e">A RetrieveImageEventArgs that contains event data.</param>
        protected virtual void OnRetrieveItemThumbnail(RetrieveItemThumbnailEventArgs e)
        {
        ...
        /// </summary>
        /// <param name="e">A RetrieveImageEventArgs that contains event data.</param>
        internal virtual void RetrieveItemThumbnailInternal(RetrieveItemThumbnailEventArgs e)
        {
        ...
        /// </summary>
        [Category("Behavior"), Browsable(true), Description("Occurs before picture become loaded.")]
        public event RetrieveItemImageEventHandler RetrieveItemImage;

        //JTN Added   
        /// <summary>
        /// Occurs before loading a picture become loaded.
        /// </summary>
        [Category("Behavior"), Browsable(true), Description("Occurs before thumbnail become loaded.")]
        public event RetrieveItemThumbnailEventHandler RetrieveItemThumbnail;

        //JTN Added 
        /// <summary>
        /// Occurs before loading a picture become loaded.
        /// </summary>
        [Category("Behavior"), Browsable(true), Description("Occurs before metadata become loaded.")]
        public event RetrieveItemMetadataDetailsEventHandler RetrieveItemMetadataDetails;
        #endregion
    }
}

    ...
    public static class Utility
    {
        ...
        public class ShellImageFileInfo
        {
            ...
            public void ReadShellImageFileInfo(string path)
            {
                ...
                {
                    int count = 100;
                    while (!File.Exists(path) && count-->0) System.Threading.Thread.Sleep(10); //Exiftool delete and rename files after updates, when delete and rename file are gone for few ms.

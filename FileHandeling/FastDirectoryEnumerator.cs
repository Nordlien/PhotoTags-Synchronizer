...
namespace FileHandeling
{
    ...
    public class FileData
    {
        ...
        #region FileData(string dir, WIN32_FIND_DATA findData)
        /// <summary>
        ...
        #region DateTime ConvertDateTime
    ...
    #region FastDirectoryEnumerator
    /// <summary>
    ...
    {
        #region IEnumerable<FileData> EnumerateFiles(string path)
        /// <summary>
        ...
        #region IEnumerable<FileData> EnumerateFiles(string path, string searchPattern)
        /// <summary>
        ...
        #region IEnumerable<FileData> EnumerateFiles(string path, string searchPattern, SearchOption searchOption)
        /// <summary>
        ...
        #region DllImport("kernel32.dll") - SafeFindHandle : SafeHandleZeroOrMinusOneIsInvalid
        /// <summary>
        ...
        {
            #region FileEnumerator - DllImport("kernel32.dll"), FindFirstFile
            [DllImport("kernel32.dll", CharSet = CharSet.Auto, SetLastError = true)]
            private static extern SafeFindHandle FindFirstFile(string fileName, [In, Out] WIN32_FIND_DATA data);
            #endregion

            #region FileEnumerator - DllImport("kernel32.dll"), FindNextFile
            [DllImport("kernel32.dll", CharSet = CharSet.Auto, SetLastError = true)]
            ...
            #region FileEnumerator(string path, string filter, SearchOption searchOption)
            /// <summary>
            ...
            #region IEnumerator.MoveNext ------------------ Logic-----
            /// <summary>

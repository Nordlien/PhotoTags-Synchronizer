...
namespace PhotoTagsSynchronizer
{
    ...
    public class FilterVerifyer
    {
        ...
        public static void PopulateTreeViewBasicNodes(TreeView treeView, string rootNode)
        {
            ...
            treeView.Nodes[rootNode].Nodes.Add(FilterVerifyer.Albums, FilterVerifyer.Albums);
            treeView.Nodes[rootNode].Nodes.Add(FilterVerifyer.Titles, FilterVerifyer.Titles);
            treeView.Nodes[rootNode].Nodes.Add(FilterVerifyer.Comments, FilterVerifyer.Comments);
            treeView.Nodes[rootNode].Nodes.Add(FilterVerifyer.Descriptions, FilterVerifyer.Descriptions);
            treeView.Nodes[rootNode].Nodes.Add(FilterVerifyer.Authors, FilterVerifyer.Authors);
            treeView.Nodes[rootNode].Nodes.Add(FilterVerifyer.Ratings, FilterVerifyer.Ratings);
            treeView.Nodes[rootNode].Nodes.Add(FilterVerifyer.Dates, FilterVerifyer.Dates);

            treeView.Nodes[rootNode].Nodes.Add(FilterVerifyer.Locations, FilterVerifyer.Locations);
            treeView.Nodes[rootNode].Nodes.Add(FilterVerifyer.Cities, FilterVerifyer.Cities);
            treeView.Nodes[rootNode].Nodes.Add(FilterVerifyer.States, FilterVerifyer.States);
            treeView.Nodes[rootNode].Nodes.Add(FilterVerifyer.Countries, FilterVerifyer.Countries);

            treeView.Nodes[rootNode].Nodes.Add(FilterVerifyer.Peoples, FilterVerifyer.Peoples);
            treeView.Nodes[rootNode].Nodes.Add(FilterVerifyer.Keywords, FilterVerifyer.Keywords);
        }

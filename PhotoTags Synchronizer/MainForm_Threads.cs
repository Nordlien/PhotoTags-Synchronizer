...
namespace PhotoTagsSynchronizer
{
    public partial class MainForm : Form
    {
        ...
        public void ThreadPreloadningMetadata()
        {
            try
            {
                if (
                   ...
                   ) && CommonQueuePreloadingMetadataCountLock() > 0 && ThreadLazyLoadingQueueSize() == 0)
                {
        ...
        /// </summary>
        /// <param name="searchFilterResult">List of FileEntires to put in cache</param>
        ...
        public void ThreadLazyLoadningMetadata()
        {
            try
            {
                if (
                   ...
                   ) && CommonQueueLazyLoadingMetadataCountLock() > 0)
                {

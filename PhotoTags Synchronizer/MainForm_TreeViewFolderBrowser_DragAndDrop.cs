    ...
    public partial class MainForm : KryptonForm
    {
        ...
        private void treeViewFolderBrowser1_ItemDrag(object sender, ItemDragEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                KryptonMessageBox.Show("Failed create drag and drop transfer data. Error: " + ex.Message, "Syntax error...", MessageBoxButtons.OK, MessageBoxIcon.Error, showCtrlCopy: true);
                treeViewFolderBrowser1.Focus();
            }
        }
        #endregion

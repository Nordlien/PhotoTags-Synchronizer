            ...
            if (!GlobalData.IsApplicationClosing && GlobalData.IsDragAndDropActive)
            {
                ...
                while (GlobalData.IsDragAndDropActive && retry)
                {
                    if (
                        ...
                        (KryptonMessageBoxButtons)MessageBoxButtons.RetryCancel,
            ...
            try
            {
                if (IsAnyDataUnsaved())
                {
                    ...
                    dialogResult = KryptonMessageBox.Show(
                        ...
                        (canCancel ? (KryptonMessageBoxButtons)MessageBoxButtons.YesNoCancel : (KryptonMessageBoxButtons)MessageBoxButtons.YesNo), KryptonMessageBoxIcon.Warning, showCtrlCopy: true);

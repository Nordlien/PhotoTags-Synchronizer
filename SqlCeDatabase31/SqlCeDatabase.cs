...
namespace ChristianHelle.DatabaseTools.SqlCe
{
    public class SqlCeDatabase : ISqlCeDatabase
    {
        ...
        public void Verify()
        {
            using (var engine = new SqlCeEngine(ConnectionString)) engine.Verify();
        }

        public void Shrink()
        {
            using (var engine = new SqlCeEngine(ConnectionString)) engine.Shrink();
        }

        public void Compact()
        {
            using (var engine = new SqlCeEngine(ConnectionString)) engine.Compact(null);
        }
